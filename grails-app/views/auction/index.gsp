		...
		<div id="list-auction" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<th><g:message code="auction.owner.label" default="Owner" /></th>
				...
				<g:each in="${auctionInstanceList}" status="i" var="auctionInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${auctionInstance.id}">${fieldValue(bean: auctionInstance, field: "owner")}</g:link></td>
