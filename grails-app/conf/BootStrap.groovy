    ...
    def init = { servletContext ->
        environments{
            development {
                ...
                def a1 = new Auction(id: 'test1', name:'auct-1', description: 'ok, here', begDate: Date.parse('MM/dd/yyyy', '03/01/2015'), endDate: Date.parse('MM/dd/yyyy', '03/01/2015'), minAmount: '10', buyAmount: '100', owner: u1).save(failOnError: true)
